...
class Client:
    ...
    def gui_loop(self):
        ...
        self.chat_label = tkinter.Label(
            self.win, text="Chat:", bg="lightgray")  # individual component
        ...
        # consequence: can't alter the stylings of the messages in the history
        self.text_area.config(state='disabled')
        # need to make it default(enable) again to style it

        # Label for message area
        self.msg_label = tkinter.Label(
            self.win, text="Message:", bg="lightgray")  # individual component
    ...
    def write(self):
        ...
        # 1.0 meaning starting from the beginning of the text to the end
